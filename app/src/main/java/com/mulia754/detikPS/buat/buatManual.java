...
public class buatManual extends AppCompatActivity implements
        View.OnClickListener {
    private static final String TAG = buatManual.class.getSimpleName();
    ...
    Spinner spinner;
    String nama;
   private String gambarBos;
    TextView tv_siswa;

    Button btn_submit;
    Button button;
    TextView editText,name,gambarSebelah;
    Context context;
   ...
   Button btnDatePicker, btnTimePicker,btnHariPicker,btnOK;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_buat_manual);
        ...
        gambarBos = extras.getString(KEY_NAME);
...
//zzzzzzzzzzzzzzzzzzzzzzzzzzz
        ...
        mProgressDialog=new ProgressDialog(buatManual.this);

        button = findViewById(R.id.btniGambarBerita);
        editText = findViewById(R.id.etNoteCover);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE) {
            ...
            if (resultCode == RESULT_OK) {
                ...
                Log.e("Nameberita",resultUri.toString());
                mProgressDialog.setTitle("Uploading Image....");
                mProgressDialog.setMessage("Please Wait....");
                mProgressDialog.show();
                mProgressDialog.setCanceledOnTouchOutside(false);

                final StorageReference filepath=mStorageRef.child("Imagesberita").child(random()+".jpg");
                filepath.putFile(resultUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    @Override
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        String Duriberita=taskSnapshot.getUploadSessionUri().toString();
                        Log.e("duriberita",Duriberita);
                        String Uuriberita=taskSnapshot.getStorage().child("Imagesberita").getDownloadUrl().toString();
