...
public class buatVideo extends AppCompatActivity {
    private static final String TAG = buatVideo.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mProgressDialog=new ProgressDialog(buatVideo.this);
