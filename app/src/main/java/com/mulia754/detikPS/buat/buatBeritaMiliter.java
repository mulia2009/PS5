...
import com.mulia754.detikPS.database.presenter.NotePresenter5;
...
public class buatBeritaMiliter extends AppCompatActivity implements
        View.OnClickListener{
    private static final String TAG = buatBeritaMiliter.class.getSimpleName();
    private AnimationDrawable animationDrawable;

    private NotePresenter5 mNotePresenter5;
    ...
    TextView editText;
    Context context;
    private StorageReference mStorageRef5;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.buatberitamiliter);
...
//zzzzzzzzzzzzzzzzzzzzzzzzzzz
        mStorageRef5 = FirebaseStorage.getInstance().getReference();
        mProgressDialog=new ProgressDialog( buatBeritaMiliter.this);
        ...
        mNotePresenter5 = new NotePresenter5();
        ...
        btnNoteSave.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String title5 = etNoteTitle.getText().toString();
                String content5 = etNoteContent.getText().toString();
                String waktu5 = etNoteWaktu.getText().toString();
                String cover5 = etNoteCover.getText().toString();

                mNotePresenter5.create(title5,content5,waktu5,cover5);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE) {
            ...
            if (resultCode == RESULT_OK) {
                ...
                final StorageReference filepath=mStorageRef5.child("Imagesnew").child(random()+".jpg");
