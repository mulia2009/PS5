...
import com.mulia754.detikPS.database.presenter.NotePresenter3;
import com.theartofdev.edmodo.cropper.CropImage;
import com.theartofdev.edmodo.cropper.CropImageView;

import java.util.Random;

public class buatBeritaLainLain extends AppCompatActivity {
    private static final String TAG = buatBeritaLainLain.class.getSimpleName();

    private NotePresenter3 mNotePresenter3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.buatberitalainlain);
        ...
        mStorageRef3 = FirebaseStorage.getInstance().getReference();
        mProgressDialog=new ProgressDialog( buatBeritaLainLain.this);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                CropImage.activity()
                        ...
                        .start( buatBeritaLainLain.this);

            }
        });
        mNotePresenter3 = new NotePresenter3();
        ...
        btnNoteSave.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String title3 = etNoteTitle.getText().toString();
                String content3 = etNoteContent.getText().toString();
                String waktu3 = etNoteWaktu.getText().toString();
                String cover3 = etNoteCover.getText().toString();

                mNotePresenter3.create(title3,content3,waktu3,cover3);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE) {
            ...
            if (resultCode == RESULT_OK) {
                ...
                final StorageReference filepath=mStorageRef3.child("Imagesvideo").child(random()+".jpg");
